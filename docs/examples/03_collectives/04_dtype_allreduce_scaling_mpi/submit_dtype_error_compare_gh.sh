...
echo "setting=ACCOUNT=${ACCOUNT} PARTITION=${PARTITION} TIME_LIMIT=${TIME_LIMIT} NCCL_NVFP4_ALLREDUCE_IMPL=${NCCL_NVFP4_ALLREDUCE_IMPL} NCCL_ALGO=${NCCL_ALGO} NCCL_PROTO=${NCCL_PROTO} NCCL_MIN_NCHANNELS=${NCCL_MIN_NCHANNELS} NCCL_MAX_NCHANNELS=${NCCL_MAX_NCHANNELS}"
